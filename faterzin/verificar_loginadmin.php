...
$sqlaaaaaa = "SELECT painel FROM funcionarios WHERE user = '$usuarioaaa' AND admin = '1'";
...
if ($resultaaaa->num_rows > 0) {
    ...
    if ($row['painel'] == 1) {
        ...
        echo "<script language='javascript' type='text/javascript'>alert('Você não tem permissão para acessar esta página admin.');window.location.href='../dashboard.php';</script>";
        exit();
    }
} else {
